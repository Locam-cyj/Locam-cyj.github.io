$(function(){
    ...
    var musicNameData = ['Luv Letter','Flower Dance','Letter'];                   // 歌曲名数组
    var artistNameData = ['DJ OKAWARI','DJ OKAWARI','iris']            // 创作歌手数组
    var musicUrls=['mp3/Luv Letter.mp3','mp3/Flower Dance.mp3','mp3/Letter.mp3'];// 歌曲mp3数组
